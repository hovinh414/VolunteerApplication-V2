...
const noneAvatar = require('../assets/hero3.jpg')
...
const cloth = require('../assets/icon/cloth.png')
const dishes = require('../assets/icon/dishes.png')
const stationery = require('../assets/icon/stationery.png')
const food = require('../assets/icon/food.png')
const medicine = require('../assets/icon/medicine.png')
const toy = require('../assets/icon/toy.png')
const noodles = require('../assets/icon/noodles.png')
